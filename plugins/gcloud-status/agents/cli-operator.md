...
| Error                                     | Action                                                        |
| ----------------------------------------- | ------------------------------------------------------------- |
| `gcloud: command not found`               | Report: gcloud CLI not installed, suggest `/gcloud-status:setup` |
| `You do not currently have an active account` | Report: not authenticated, suggest `/gcloud-status:gcloud-login` |
...
| `token expired`                           | Report: re-authenticate with `/gcloud-status:gcloud-login`    |
