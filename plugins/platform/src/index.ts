import { type CeEventBus, createCePlatformService, registerCePlatformService } from './ce/service';
...
const factory: ExtensionFactory = async (pi) => {
  ...
  if (pi.events) registerCePlatformService(pi.events, createCePlatformService());
