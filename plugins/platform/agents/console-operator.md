...
- **Authentication**: Read
  `plugins/platform/skills/console-auth/SKILL.md` and
  `plugins/platform/skills/console-auth/references/azure-sso-flow.md`
- **Navigation**: Read
  `plugins/platform/skills/console-navigator/SKILL.md` and
  `plugins/platform/skills/console-navigator/references/url-patterns.md`
- **Session check**: Read
  `plugins/platform/skills/console-auth/references/session-detection.md`
