...
| ---- | ----- | ----------- |
| **Demo operations** | `sales-engineer:demo-ops` | Prepare the demo environment before a meeting or tear down after a meeting |
| **API-driven demo** | `sales-engineer:demo-executor` | Execute live demo phases, handle Q&A, and run post-session debrief |
| **Walkthrough presentation** | `sales-engineer:presenter` | Walk a customer through the pre-configured demo environment using as-built documentation pages |
| **Q&A / subject matter expert** | `sales-engineer:subject-matter-expert` | Answer questions about product capabilities, compliance alignment, threat coverage, and platform operations |
