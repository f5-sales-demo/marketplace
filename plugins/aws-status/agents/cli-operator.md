...
| Error                              | Action                                                               |
| ---------------------------------- | -------------------------------------------------------------------- |
| `aws: command not found`           | Report: AWS CLI not installed, suggest `/aws-status:setup`           |
| `Unable to locate credentials`     | Report: no credentials configured, suggest `/aws-status:aws-login`   |
