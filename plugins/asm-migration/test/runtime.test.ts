...
describe('runtime', () => {
  ...
  test('writes exactly four deterministic files without sensitive metadata', async () => {
    ...
    expect(hashes).toEqual({
      'config-pack.json': 'f86b2d9dfd36f06ab57bb0f5ec4e29ba18fe3e0c63b6bd14ee0f0913f3ffe8bd',
      ...
      'manifest.json': 'ec75fc44816175f70f4e25566405374fd98f9bf953eab9af46b661e369606730',
    });
  });
