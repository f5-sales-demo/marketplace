...
```text
/f5xc-meddpicc:qualify-deal Acme Corp --sfdc 006000000000000AAA
```
...
```text
/f5xc-meddpicc:champion-test <HISTORICAL_IDENTITY_445011F73A> Director of Platform Engineering
```
