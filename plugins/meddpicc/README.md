...
### Deal qualification (`/meddpicc:qualify-deal`)
...
### Champion test (`/meddpicc:champion-test`)
...
### Mutual Action Plan (`/meddpicc:build-map`)
...
```bash
claude /plugin install --dir ./plugins/meddpicc
```
