...
export const AZURE_CE_RESEARCH_GATE = [
  ...
  'For an initial Terraform deployment only, an unaccepted exact discovered F5 XC Marketplace plan is accepted by the pinned Terraform apply action before VM admission. Do not run az vm image terms accept, accept arbitrary offers, or claim this applies to native, replacement, or repair workflows.',
