...
export const AZURE_CE_RESEARCH_GATE = [
  ...
  'For an initial Terraform deployment only, one idempotent terraform apply accepts an unaccepted exact discovered F5 XC Marketplace plan through its pinned action before VM admission. It requires no human acceptance, separate terms authorization, CLI command, manual state action, import, taint, rediscovery, or replan. Do not accept arbitrary offers or claim this applies to native, replacement, or repair workflows.',
