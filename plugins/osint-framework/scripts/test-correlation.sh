...
IP1=$(osint_entity_add "ip" "192.0.2.65" org="F5 Networks" --tool dig --investigation test-001)
assert_contains "IP entity created" "e-" "$IP1"

E1=$(osint_entity_add "email" "history-170259f130ad@example.com" --tool inference --investigation test-001)
...
osint_entity_add "email" "history-170259f130ad@example.com" --tool whois --investigation test-001 >/dev/null
