...
**f5xc-firecrawl** 插件通过开源 [firecrawl](https://github.com/mendableai/firecrawl) 引擎提供本地自托管网页抓取功能。无需 API 密钥，无需订阅，无需云端依赖。所有操作均在 devcontainer 内的本地 firecrawl 实例（`localhost:3002`）上运行。
