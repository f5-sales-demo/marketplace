...
6. **स्थानीय स्तर पर परीक्षण करें**
   ...
   प्रकाशित किए बिना अपने प्लगइन का परीक्षण करें, Claude Code को
   स्थानीय निर्देशिका की ओर इंगित करके:

   ```bash
   claude --plugin-dir ./plugins/example-plugin
   ```

   सत्यापित करें कि स्किल सही संदर्भ में सक्रिय होती हैं और
...
<Aside type="tip" title="रिपॉजिटरी वर्कफ़्लो">
  यह रिपॉजिटरी एक कड़े गवर्नेंस वर्कफ़्लो को लागू करती है।
...
- **बुद्धिमानी से दायरा तय करें** — जब संभव हो तो कार्यशील सेट को
  सीमित करने के लिए uncommitted परिवर्तनों की जाँच करें
...
- **एक README लिखें** — उपयोग के उदाहरण और प्रत्येक स्किल और कमांड का
  विवरण शामिल करें
