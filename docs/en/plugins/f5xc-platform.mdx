...
<Badge text="v4.0.0" variant="note" /> <Badge text="Productivity" variant="tip" />
...
The native `f5xc_ce_v2_site` tool plans and applies Secure Mesh Site v2
configuration. `f5xc_ce_v2_bootstrap` checks out one-use bootstrap material and
...
Legacy Azure VNet Site, Fleet, and shared registration-token routes are not
available in Platform 4.x.
