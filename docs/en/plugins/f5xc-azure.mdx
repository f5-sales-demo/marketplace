...
its generated configuration signs only the live-discovered F5 XC Marketplace
agreement as part of the same `terraform apply` that admits the VMs. Destructive
