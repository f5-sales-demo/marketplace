...
description: MDX content validation and quality checks for the f5-sales-demo documentation pipeline.
sidebar:
  order: 4
---
...
the f5-sales-demo documentation pipeline. It catches common
...
working with MDX files in an f5-sales-demo content
...
<CardGrid>
  ...
  <Card title="Import validation">
    ...
    built-in and f5-sales-demo theme components.
  </Card>
...
**f5-sales-demo theme components** (`@f5-sales-demo/docs-theme/components/`):
