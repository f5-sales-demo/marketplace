...
description: >-
  Web scraping e crawling self-hosted locali tramite il motore open-source
  Firecrawl.
sidebar:
  order: 13
i18n:
...
Il plugin **f5xc-firecrawl** fornisce web scraping self-hosted locale
...
Scopre tutti gli URL presenti su un sito web.
...
Esegue ricerche sul web e, facoltativamente, effettua lo scraping dei risultati.
...
gli endpoint v1. Agente in sola lettura (nessuno strumento di scrittura, modifica o agente).
...
- Viene eseguito interamente all'interno della rete del container locale
