...
- **`asm-migration`** v2.0.4 — emits a single XC-compatible query-parameter
  ...
  ([#1275](https://github.com/f5-sales-demo/marketplace/issues/1275)).

- **`asm-migration`** v2.0.3 — emits XC-compatible RE2 parameter-range
  predicates without lookahead while preserving presence semantics. Config
  packs generated by earlier versions must be reconverted ([#1273](https://github.com/f5-sales-demo/marketplace/issues/1273)).
